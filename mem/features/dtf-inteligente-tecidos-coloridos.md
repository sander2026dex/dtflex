...
description: Camada separada em public/dtflex-tool/index.html para camisas coloridas — remoção de fundo ativa, base branca adaptativa, preservação de preto e preview na cor do tecido
type: feature
---
